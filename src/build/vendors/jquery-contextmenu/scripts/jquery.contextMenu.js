                ...
                $.each(opt.items, function (key, item) {
                    ...
                    if (item.type && types[item.type]) {
                        ...
                        switch (item.type) {
                            ...
                            case 'text':
                                $input = $('<input class="form-control" type="text" value="1" name="" />')
                            ...
                            case 'textarea':
                                $input = $('<textarea class="form-control" name=""></textarea>')
                                    .attr('name', 'context-menu-input-' + key)
                                    .val(item.value || '')
                                    .appendTo($label);
                            ...
                            case 'checkbox':
                                $input = $('<input class="form-control" type="checkbox" value="1" name="" />')
                                    .attr('name', 'context-menu-input-' + key)
                                    .val(item.value || '')
                            ...
                            case 'radio':
                                $input = $('<input class="form-control" type="radio" value="1" name="" />')
                            ...
                            case 'select':
                                $input = $('<select class="custom-select" name=""></select>')
                                    .attr('name', 'context-menu-input-' + key)
                                    .appendTo($label);
                                if (item.options) {
